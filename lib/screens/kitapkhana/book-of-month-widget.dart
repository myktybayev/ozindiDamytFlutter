                                      ...
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.only(
                                              top: 25, left: 25, bottom: 5),
                                          child: Column(
                                            children: [
                                              Container(
                                                  margin: EdgeInsets.only(right: 25),
                                                  child:
                                                  Text('Осы айдың', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, fontFamily: 'Comfortaa', color: Colors.white))),
                                              Container(
                                                  margin: EdgeInsets.only(right: 25, top: 5),
                                                  child: Text('үздік кітабі ', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, fontFamily: 'Comfortaa', color: Colors.white))),
                                            ],
                                          ),
                                        ),
